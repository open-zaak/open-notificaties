...
Open Notificaties produces application metrics (using Open Telemetry).
...
.. important:: Some metrics are defined as "global scope".
   ...
   .. code-block:: promql
       ...
       avg by (type) (otel_opennotificaties_auth_user_count{scope="global"})
...
helping to monitor load, the most frequent operations, and allowing for various aggregations.
