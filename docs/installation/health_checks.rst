...
Open Notificaties is deployed as a collection of containers.
...
are provided in Open Notificaties, or the health checks to implement in containers of third
party software typically used in an Open Notificaties deployment. You can incorporate these in
...
.. _docker-compose.yml: https://github.com/open-zaak/open-notificaties/blob/main/docker-compose.yml
...
Open Notificaties containers
============================

HTTP service
------------

The Open Notificaties web service listens on port 8000 inside the container and accepts HTTP
...
The Open Notificaties Beat service is responsible for periodically scheduling background
...
The ``CELERY_BEAT_SCHEDULE`` setting (in :mod:`nrc.conf.base`) contains some tasks
